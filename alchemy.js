const ORGANISM_LIST = ["Air;None;None",
"Earth;None;None",
"Fire;None;None",
"Water;None;None",
"Alcohol;Fire;Water",
...
//The first 4 organisms have no parents.
...
function initialize() {
    ...
    mrOrganisms = ORGANISM_LIST[0], ORGANISM_LIST[1],
...
function areParents(organism, parent1, parent2) {
    ...
    var parent1 = getOrgniamsData(parent1, NAME);
...
function deleteOrganism() {
    var idx = parseInt(organism.orgsel.value)-1;
